...
% Calculation of d(t)
A = 0.3;                    % Amplitude of AC component of desired distance
...
x_coor = [-0.5;0.5;0;0;0;0];
% y coordinate of framework F*(t) 
y_coor = [0.3; 0.3; 0.05;-0.2; -0.7 ;-0.45 ];
...
x_coor_dot = [-0.5;0.5;0;0;0;0];
y_coor_dot = [0.3; 0.3; 0.05;-0.2; -0.7 ;-0.45 ];  
